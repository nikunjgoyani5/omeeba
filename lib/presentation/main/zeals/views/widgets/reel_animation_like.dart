...
import 'package:omeeba_new/presentation/main/zeals/views/widgets/debounce_action.dart';
import 'package:omeeba_new/presentation/main/zeals/views/widgets/gradient_icon.dart';
import 'package:omeeba_new/presentation/main/zeals/views/widgets/haptic_manager.dart';
...
class Heart extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GradientIcon(
        ...
        child: Icon(Icons.favorite, size: _width,)
      );
}
