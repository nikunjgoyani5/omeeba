...
import 'package:omeeba_new/presentation/main/zeals/views/widgets/duration_extension.dart';
...
class _ReelSeekBarState extends State<ReelSeekBar> {
  ...
  Future<void> _createOverlay() async {
    ...
    String url = widget.controller.reelData.value.video ?? '';
      ...
      builder: (context) {
        ...
        return ValueListenableBuilder<Offset?>(
          ...
          builder: (context, offset, _) {
            ...
            final top = MediaQuery.of(context).size.height * 0.75 - ( 80);
